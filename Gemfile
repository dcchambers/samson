...
group :preload do
  ...
  gem 'dotenv'
  gem 'connection_pool'
  gem 'marco-polo', git: "git@github.com:jurajmasar/marco-polo.git", branch: "master" # https://github.com/arches/marco-polo/pull/10
...
group :test do
  gem 'minitest-rails', git: "git@github.com:grosser/minitest-rails.git", branch: "grosser/absolute" # https://github.com/blowmage/minitest-rails/pull/224
